 ...
 */
public class StockReservationResultId implements Serializable {
     ...
     * JPA 用デフォルトコンストラクタ。
     */
    public StockReservationResultId() {
    }
     ...
     */
    public StockReservationResultId(String orderId, int orderLineNo) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof StockReservationResultId that)) {
            return false;
        }
