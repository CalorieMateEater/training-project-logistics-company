...
class BusinessHoursServiceTest {
  ...
  void shouldReturnTrueWithinBusinessHours() {
    assertThat(businessHoursService.isBarBusinessHours(LocalDateTime.of(2026, 6, 17, 9, 0)))
        .isTrue();
  }
  ...
  void shouldReturnNextWeekdayMorningOutsideBusinessHours() {
    LocalDateTime next =
        businessHoursService.nextBarBusinessTime(LocalDateTime.of(2026, 6, 20, 10, 0));
