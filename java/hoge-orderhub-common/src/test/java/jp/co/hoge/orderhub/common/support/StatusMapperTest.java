...
class StatusMapperTest {
    ...
    void shouldMapDeliveredToCompleted() {
        assertThat(statusMapper.toOrderStatus(DeliveryStatusCode.DELIVERED)).isEqualTo(OrderStatus.COMPLETED);
    }

    @Test
    void shouldMapAddressErrorToException() {
        assertThat(statusMapper.toOrderStatus(DeliveryStatusCode.ADDRESS_ERROR)).isEqualTo(OrderStatus.EXCEPTION);
    }
}
