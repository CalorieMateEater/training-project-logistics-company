...
class ShipmentRegistrationServiceTest {
    ...
    @Captor
    private ArgumentCaptor<ShipmentRequestEntity> shipmentRequestCaptor;
    ...
    void setUp() {
        ...
        shipmentRegistrationService = new ShipmentRegistrationService(
    ...
    @Test
    void shouldRegisterFugaShipment() {
        when(orderHeaderRepository.findByPartnerRequestId("FG202606170001")).thenReturn(Optional.empty());
        when(orderHeaderRepository.findByPartnerOrderId("FGO202606170001")).thenReturn(Optional.empty());
        ...
        when(stockKeeperClient.reserve(any()))
                .thenReturn(new StockReservationResponse("RSV-1", "RESERVED", java.util.List.of()));
        ...
        FugaShipmentAcceptedResponse response = shipmentRegistrationService.register(
                new FugaShipmentRequest(
                        "FG202606170001",
                        "FGO202606170001",
                        "C00000000001",
                        "ITM0000001",
                        ...
                        "STANDARD",
                        "RESERVED",
                        new FugaShipmentRequest.DeliveryConstraint("AMBIENT", "EVENING"),
                        "1000001",
                        "Tokyo",
        ...
        assertThat(shipmentRequestCaptor.getValue().getShipmentRequestStatus()).isEqualTo(ShipmentRequestStatus.PENDING);
    }
}
