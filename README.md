...
本リポジトリには、要件定義（システム間連携図、外部インターフェース一覧、対外連携資料を含む）、自社内部設計、基盤設計、運用設計、PJ管理資料と、それに対応する Spring Boot / Gradle / Java 17 の実装が含まれています。
...
- `docs/要件定義/要件定義概要.md`
- `docs/要件定義/システム概要.md`
- `docs/要件定義/システム間連携図.md`
- `docs/要件定義/外部インターフェース一覧.md`
- `docs/要件定義/アクター定義書.md`
- `docs/要件定義/業務機能一覧.md`
- `docs/要件定義/業務ルール定義書.md`
- `docs/要件定義/業務フロー/`
- `docs/要件定義/対外連携/フー社/連携ファイル設計書.md`
- `docs/要件定義/対外連携/バー社/連携API設計書.md`
- `docs/要件定義/対外連携/バー社/連携APIアプリ設計書.md`
- `docs/要件定義/対外連携/バー社/連携API基盤設計書.md`
- `docs/要件定義/対外連携/フーガ社/連携API設計書.md`
- `docs/要件定義/対外連携/フーガ社/連携APIアプリ設計書.md`
- `docs/要件定義/対外連携/フーガ社/連携API基盤設計書.md`
- `docs/要件定義/対外連携/バズ社/連携メッセージ設計書.md`
- `docs/要件定義/対外連携/クックス社/連携メッセージ設計書.md`
